...
<head>
<meta charset="UTF-8">
<title>Staff Login to Update service</title>
...
<body>
	...
	<div class="class1">
		...
		<br>
	<div>
		<form action="updateServiceByStaff.jsp" method="POST">
	
			Enter Service ID : <input type="text" name="CustomerServiceID"><br><br>
			Enter Customer Username : <input type="text" name="CustomerUserName"><br><br>
			
			
			<h3>${requestScope.output}</h3>
			
			 <input type="submit" value="Update" class="btn btn-info"> <br><br><!--
			<a href="updateServiceByStaff.jsp"><button type="button" class="btn btn-secondary">Update</button></a>-->
	<a href="staffLoggedPage.jsp"><button type="button" class="btn btn-primary">Return Staff Potal </button></a>
			<a href="HomePage.jsp"><button type="button" class="btn btn-primary">Return Home Page</button></a>
		</form>
	</div>
	</div>
