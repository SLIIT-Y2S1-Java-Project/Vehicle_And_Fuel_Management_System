...
<div>
	...
	<div class="class1">
		...
		<div >
			<caption>Staff Details</caption><br>
		...
		<form action="updateStaffByAdmin2" method="POST">
			Enter Full Name : <input type="text" name="staffName" value="${requestScope.output[0]}"><br><br>
			Enter Address : <input type="text" name="staffAddress" value="${requestScope.output[1]}"><br><br>
			Enter Email : <input type="email" name="staffEmail" value="${requestScope.output[2]}"><br><br>
			
			Gender : <br>
			Male <input type="radio" name="staffGender" value="male">
			Female <input type="radio" name="staffGender" value="female"><br><br>
			
			
			Enter Username : <input type="text" name="staffUserName" value="${requestScope.output[4]}"><br><br>
			Enter Password : <input type="password" name="staffPassword" value="${requestScope.output[5]}"><br><br>
			
			
			
			<input class="btn btn-info" type="submit" value="Update Staff Details"><br><br>
			
			<h3>${requestScope.output2}</h3><br><br> 
		</form>
		<a href="adminLoggedPage.jsp"><button class="btn btn-primary">Return Admin Potal</button></a>
