...
<head>
<meta charset="UTF-8">
<title>Vehicle Service Delete Page</title>
...
<body>
	...
	<div class="class1">
		<div>
		<h2>Vehicle Service Delete</h2><br>
		<form action="deleteServiceByStaff" method="POST">
		
			Enter Service ID : <input type="text" name="user"><br><br>
			Enter User Name : <input type="text" name="pass"><br><br>
