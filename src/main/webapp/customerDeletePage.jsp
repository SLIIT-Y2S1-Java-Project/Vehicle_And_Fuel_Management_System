...
<head>
<meta charset="UTF-8">
<title>Customer Delete Page</title>
...
<body>
	...
	<div class="class1">
		<div>
		<h2>Customer Details Delete Page</h2><br>
		<form action="deleteBookedService" method="POST">
	...
	<a href="customerLoggedPage.jsp"><button class="btn btn-info">Return Back >></button></a>
