...
<head>
<meta charset="UTF-8">
<title>Customer Logged Page</title>
...
<body>
	...
	<div class="class1">
		...
		<h6>
			The vehicle management system for customers allows easy access to vehicle information, bookings, and service history. Customers can view available vehicles, book appointments, and track maintenance schedules. It simplifies the process of managing vehicles, ensuring a seamless experience for customers.	
		</h6>
		    ...
		    <div class="col-sm-6 mb-3 mb-sm-0">
		      <div class="card">
		        <div class="card-body">
		          ...
		          <p class="card-text">Your All Service Transaction Here. You can Update or Delete Any Transaction you made</p>
		
		          <form action="showCustomerServiceDetails" method="POST">
		            <input type="submit" value="Show All Service Transactions" class="btn btn-info mb-2">
		          </form>
		          
		          <h4>${requestScope.output}</h4>
	...
	<br><br>
		...
		<a href="customerLoginPage.jsp"><button class="btn btn-info"> Return Back</button></a>
