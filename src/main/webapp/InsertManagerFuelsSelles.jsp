	...
	<div class="container col-md-5">
		<div class="card">
			<div class="card-body">
				...
				<fieldset class="form-group">
					<label>Order Type</label> <input type="text" value="" class="form-control"name="type"required>
				</fieldset>
				...
				<fieldset class="form-group">
					<label>Order Price</label> <input type="text" value="" class="form-control" name="price"required>
				</fieldset>
				
				<fieldset class="form-group">
					<label>Phone Number</label> <input  type="number" name="phone" value="" class="form-control" placeholder="0785957049" required>
