...
<head>
<meta charset="UTF-8">
<title>Admin Login to Update staff</title>
...
<body>
	...
	<div>
		<form action="updateStaffByAdmin" method="POST">
			...
			Enter Staff Username : <input type="text" name="staffUserName"><br><br>
			
			<h3>${requestScope.output}</h3>
			
			<input type="submit" value="Login" class="btn btn-info"><br><br>
			
			<a href="adminLoggedPage.jsp"><button type="button" class="btn btn-primary">Return Admin Potal >></button></a>
