...
<head>
<meta charset="UTF-8">
<title>Login Service Details Page</title>
...
<body>
	...
	<div class="class1">
		<h1>Login to Update Service Details</h1>
		<br>
	<div>
		<form action="updateVehicleServices" method="POST">
	
			Customer Username : <input type="text" name="user"><br><br>
			...
			<a href="customerLoggedPage.jsp"><button type="button" class="btn btn-primary">Return Back >></button></a>
