...
<head>
<meta charset="UTF-8">
<title>Show Vehicle Service</title>
...
<body>
	...
	<div class="class1">
	    <h2>Vehicle Service!</h2> <br>
	    
	    <table border="3px" cellpadding="15px" class="table1">
	    
	    <a href="bookVehicleService.jsp" class="btn btn-success mb-2">Add Vehicle Service</a><br>
	...
	<a href="loginStaffToUpdateService.jsp"><button class="btn btn-secondary">Update</button>
	   		...
	   		<td>
		   	  <form action="deleteServiceByStaff.jsp"  method="POST" >
	...
	<tr>
	   		...
	   		<td><a href="loginStaffToUpdateService.jsp"><button class="btn btn-secondary">Update</button></a></td>
	   		<td><a href="deleteServiceByStaff.jsp"><button class="btn btn-danger">Delete</button></a></td>
	   	</tr>
	   	...
	   	<tr>
	   		<td>${requestScope.output[5][0]}</td>
	   		<td>${requestScope.output[5][1]}</td>
	   		<td>${requestScope.output[5][2]}</td>
	   		<td>${requestScope.output[5][3]}</td>
	   		<td>${requestScope.output[5][4]}</td>
	   		<td>${requestScope.output[5][5]}</td> 
	   		<td>${requestScope.output[5][6]}</td>
	   		
	   		<td><a href="loginStaffToUpdateService.jsp"><button class="btn btn-secondary">Update</button></a></td>
	   		<td><a href="deleteServiceByStaff.jsp"><button class="btn btn-danger">Delete</button></a></td>
	   	</tr>
	   		<tr>
	   		<td>${requestScope.output[6][0]}</td>
	   		<td>${requestScope.output[6][1]}</td>
	   		<td>${requestScope.output[6][2]}</td>
	   		<td>${requestScope.output[6][3]}</td>
	   		<td>${requestScope.output[6][4]}</td>
	   		<td>${requestScope.output[6][5]}</td> 
	   		<td>${requestScope.output[6][6]}</td>
