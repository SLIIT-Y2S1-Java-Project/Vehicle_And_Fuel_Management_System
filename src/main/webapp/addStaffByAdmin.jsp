...
<head>
<meta charset="UTF-8">
<title>Add Staff By Admin</title>
		  ...
		  <div class="col-sm-6 mb-3 mb-sm-0">
		    <div class="card">
		      <div class="card-body">
		      	...
		      	<form action="addStaffByAdmin" method="POST">
		      		Full Name: <input type="text" name="staffName"><br><br>
		      		Home Address: <input type="text" name="staffAddress"><br><br>
		      		Email: <input type="email" name="staffEmail"><br><br>
		      		Gender: <br>
		      		Male <input type="radio" name="staffGender" value="male">
		      		Female <input type="radio" name="staffGender" value="female"><br><br>
		      		Username: <input type="text" name="staffUserName"><br><br>
		      		Password: <input type="password" name="staffPassword"><br><br><br>
