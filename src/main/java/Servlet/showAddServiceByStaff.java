...
/**
 * Servlet implementation class showAddServiceByStaff
 */
@WebServlet("/showAddServiceByStaff")
public class showAddServiceByStaff extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public showAddServiceByStaff() {
        super();
